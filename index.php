...
<?php 
  ...
  $sanphambanchays= $service->getAllSanPhamBanChay();
  $sanphamgiamgias =$service->getAllSanPhamDisCount();
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        padding: 30px; ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent mr-auto">
              <ul class="navbar-nav ml-auto mr-auto">
                <li class="nav-item">
                  <a class="nav-link item active" href="indexUser.php " onclick="checkactive(this)">Trang chủ</a>
                </li>
                <li class="nav-item">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel" style="width: 100%;">
      ...
      <div class="carousel-inner" >
        <div class="carousel-item active">
          <img src="../images/page3.jpg" alt="Los Angeles" width="100%" height="400">
          <div class="carousel-caption">
            <h3>Sang trọng</h3>
            <p>Tận hưởng không gian này !</p>
          </div>   
        </div>
        <div class="carousel-item">
          <img src="../images/page2.jpg" alt="Chicago" width="100%" height="400">
          <div class="carousel-caption">
            <h3>Thơm Ngon</h3>
            <p>Bổ dưỡng!</p>
          </div>   
        ...
        <div class="carousel-item">
          <img src="../images/page3.jpg" alt="New York" width="100%" height="400">
          <div class="carousel-caption">
            <h3>Bổ dưỡng</h3>
            <p>Thơm ngon !</p>
          </div>   
...
<main >
   ...
   <div class="container" style="margin-top: 30px;"> 
    <img src="https://cf.shopee.vn/file/314a465661c0ea355077972f0db7aed8_xxhdpi" style="max-width: 100%; ">
  </div>
      ...
      <div class="col-md-12">
        ...
        <div class="carousel-inner">
          ...
          <div class="item carousel-item carousel-items active">
            ...
            <?php
              for ($i=0;$i<4;$i++) {
                $percent = $sanphamgiamgias[$i]['discount']*100;
                 $dt = '<div class="col-sm-3">
                     <div class="thumb-wrapper">
                     <label class="sales">Khuyến mãi<b style="color: #008002;"> '.$percent.'%</b></label>
                     <div class="img-box">
                   
                    <a href="chitietmathang.php?id='.$sanphamgiamgias[$i]['id'].'&idc='.$sanphamgiamgias[$i]['iddanhmuc'].'">
                      <img src="../images/'.$sanphamgiamgias[$i]['image'].'" class="img-fluid" alt="">					
                    </a>
                   				
                  </div>
                  <div class="thumb-content">
                    <h4>'.$sanphamgiamgias[$i]['tensp'].'</h4>									
                    ...
                    <p class="item-price"> <b>'.$sanphamgiamgias[$i]['gia'].' vnđ</b></p>
                    <a href="#" id="'.$sanphamgiamgias[$i]['id'].'" vote="'.$sanphamgiamgias[$i]['yeuthich'].'" class="btn btn-primary addcarts" onclick="yeuthich(this)">Yêu Thích</a>
                  </div>						
                </div>
              </div>';
              echo $dt;
                ...
                $percent = $sanphamgiamgias[$i]['discount']*100;
                 $dt = '<div class="col-sm-3">
                  ...
                  <div class="thumb-content">
                    ...
                    <p class="item-price"> <b>'.$sanphamgiamgias[$i]['gia'].' vnđ</b></p>
                    <a href="#" iid="'.$sanphamgiamgias[$i]['id'].'" vote="'.$sanphamgiamgias[$i]['yeuthich'].'" class="btn btn-primary addcarts" onclick="yeuthich(this)">Yêu Thích</a>
                  </div>						
                </div>
              </div>';
              echo $dt;
  ...
  <div class="container" style="margin-top: 30px;">
       ...
       <div class="card">
           <div class="card-body">
             <div class="card-title" style="margin-bottom: 0px;     height: 348px;">
               <img class="img-product" src="http://mauweb.monamedia.net/vuonrau/wp-content/uploads/2019/05/banner-img2.png" alt="" style="    width: 100%; max-width: 100%; height: 100%;">
             </div>
           </div>
   ...
   <!--Tin tức món ngon mỗi ngày-->
   <div class="container" style="margin-bottom :20px ; margin-top: 45px;">
    <div class="row" style="border: 1px solid #eee;" >
      <div class="col col-sm-12" style="text-align: center; padding: 5px; color: #7ac400; margin-bottom:22px;"><h2><b>Thực phẩm hot !</b></h2></div>
   <?php
...
<a href="chitietmathang.php?id='.$value['id'].'&idc='.$value['iddanhmuc'].'"><img class="img-responsive" src="../images/'.$value['image'].'" style="max-width: 100px; max-height: 100px;"></a>
</div>
</div>
<div class="info-news col-sm-8 com-md-8" style="text-align: center;">
  <div class="thumb-content">
    ...
    <p class="item-price"> <b>'.$value['gia'].' vnđ</b></p>
...
echo $dt;
  ...
  <div class="container" style="margin-bottom :20px ; margin-top: 30px;">
     ...
     <div class="row" style="    border: 1px solid #eee;padding: 20px;">
       <div class="col col-sm-12" style="text-align: center; padding: 5px;  color: #7ac400;"><h2><b>Thực phẩm mới</b></h2></div>
        <div class="row">
        <?php
           ...
           <div class="card">
             <div class="card-body">
               <div class="card-title">
                 ...
                 <a href="chitietmathang.php?id='.$value['id'].'&idc='.$value['iddanhmuc'].'">
                   <img class="img-product" src="../images/'.$value['image'].'" alt="" style="    width: 100%; max-width: 100%; height: 100%;">
                 </a>
                  <div class="date">
                      <img src="../images/new.jfif" style="max-width: 100px;
                      max-height: 65px;">
                  </div>
                 </div>
             <div class="text-body" style="padding-left: 61px;">
               <div class="thumb-content">
                 ...
                 <p class="item-price"> <b>'.$value['gia'].' vnđ</b></p>
                 <a href="#" id="'.$value['id'].'" vote="'.$value['yeuthich'].'" class="btn btn-primary addcarts" onclick="yeuthich(this)">Yêu thích</a>
               </div>	
             </div>
             </div>
