...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="../admin/pages/customer/danhsachthanhvien.php">Danh sách thành viên</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
      ...
      <li class="menu-item">
        ...
        <li> <a href="../admin/pages/product/danhmucsanpham.php">Danh mục sản phẩm</a>
          </li>
          <li> <a href="../admin/pages/product/danhsachsanpham.php">Danh sách món ăn</a>
          </li>
          
          <li> <a href="../admin/pages/product/themthongtinsanpham.php">Thêm thông tin món ăn</a>
          </li>
      ...
      <li class="menu-item">
        ...
        <li> <a href="../admin/pages/dashboard/thongkesanphambanchay.php">Sản phẩm bán chạy nhất</a>
          </li>
  ...
  <main class="body-content">
    ...
    <div class="ms-content-wrapper">
      <div class="row">
        <div class="col-md-12">
          <h1 class="db-header-title">Xin chào , <?php echo $_SESSION['username']  ?></h1>
        </div>
