        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Sửa thông tin thành viên</li>
            </ol>
          </nav>
        </div>
...
if(isset($_POST["capnhat"])){
  ...
  if($_FILES['image']['name']=="") {
     $sql .="update thanhvien  set ten='$ten',username='$username',password='$password',
     email='$email',role='$role' where id='$idsp' ";
     
  }else {
     $anh=$_FILES['image']['name'];
     move_uploaded_file($tmp_name,"../../../../images/".$anh);
     $sql .="update thanhvien  set ten='$ten',username='$username',password='$password',
     email='$email',role='$role',image='$anh' where id='$idsp' ";
     
  }

  if(isset($ten)&& isset($username)&&isset($password)&& isset($email)&&isset($role)){
     $query = mysqli_query($conn,$sql);
     if($query){
       echo "
       <center class='alert alert-success text-center' style='width: 100%;'>
       ...
       echo "
       <center class='alert alert-warning text-center' style='width: 100%;'>
...
<?php
    ...
    if(isset($idsp)){
      ...
      $sql="SELECT * FROM thanhvien WHERE id=".$idsp;
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="<?php echo $info['ten'] ?>" name="ten"  >  
                </div>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="<?php echo $info['username'] ?>" name="username"  >  
                </div>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="custom-file">
                  <div class="showimage"  style="margin-bottom: 3px;">
              ...
              <div class="col-md-6 mb-3">
              <p class="medium">Role :  </p>
              <div class="form-control" style="width: 50%;">
                <input id="status1" name="role" type="radio"  <?php if($info['role']==1) echo 'checked'; ?>  value="1"><label for="status1">Admin</label>
                <input id="status2" name="role" type="radio"  <?php if($info['role']==0) echo 'checked'; ?> value="0"><label for="status2">User</label>
               </div>
               </div>
    
              <div class="ms-panel-header new text-center col-md-12 mb-3">
              <input class="btn btn-success d-block" type="submit" name="capnhat" value="Cập nhất">
             </div>
            </div>
            </form>
        </div>
