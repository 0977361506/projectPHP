...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <!-- product -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#product" aria-expanded="false" aria-controls="product"> <i class="fa fa-archive fs-16"></i>Quản lý thông tin món ăn</span>
        </a>
...
<?php
   ...
   if(isset($_POST["themmoi"])){
     ...
     if(isset($mota)&& isset($ten)&&isset($gia)&& isset($giamgia)&&isset($hot)&& isset($status)
       &&isset($danhmuc)&& isset($anh)
       ){
         move_uploaded_file($tmp_name,"../../../../images/".$anh); // upload vào folder ảnh
        $sql ="INSERT INTO sanpham (tensp,gia,discount,image,sltrongkho,sldaban,mota,yeuthich,trangthai,hot,iddanhmuc,new) 
        VALUES ('$ten', '$gia', '$giamgia','$anh','$sl','0','$mota','0','$status','$hot','$danhmuc','$moi' ) ";
      ...
      <div class="ms-panel ms-panel-fh">
        ...
        <div class="ms-panel-body">
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="validationCustom18" name="ten" placeholder="tên món ăn" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <label for="validationCustom22">Giảm giá</label>
                 <div class="input-group">
                  <input type="number" class="form-control" id="giảm giá" placeholder="giảm giá" name="giam" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="number" class="form-control" id="validationCustom24" placeholder="01" name="sl" required>
                  <div class="invalid-feedback">
                    Nhập số lượng
                  </div>
                </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="number" class="form-control" id="validationCustom25" placeholder="giá sản phẩm" name="gia"  required >
                  <div class="invalid-feedback">
                   Nhập giá món ăn .
                  </div>
                </div>
                ...
                <div class="custom-file">
                  <input type="file"  name="hinhanhs" required>
               
                
                  <div class="invalid-feedback">Vui lòng chọn ảnh cho món ăn của mình !</div>
                </div>
              </div>
              <div class="ms-panel-header new col-md-4 mb-3">
              <p class="medium">Sản phẩm hot :  </p>
              <div class="form-control" style="width: 75%;">
                <input id="status1" name="hot" type="radio" value="1"><label for="status1">Yes</label>
                <input id="status2" name="hot" type="radio" value="0"><label for="status2">No</label>
               </div>
            </div>
              <div class="ms-panel-header new col-md-4 mb-3" >
              <p class="medium">Trạng thái :  </p>
              <div class="form-control" style="width: 75%;">
                <input id="status1" name="status" type="radio" value="1"><label for="status1">Hiển thị</label>
                <input id="status2" name="status" type="radio" value="0"><label for="status2">Ẩn</label>
               </div>
            </div>
            <div class="ms-panel-header new col-md-4 mb-3" >
              <p class="medium">Sản phẩm mới :  </p>
              <div class="form-control" style="width: 75%;">
                <input id="status1" name="moi" type="radio" value="1"><label for="status1">Có</label>
                <input id="status2" name="moi" type="radio" value="0"><label for="status2">Không</label>
               </div>
            </div>
              <div class="col-md-12 mb-3">
                <label for="validationCustom12">Mô tả </label>
                <div class="input-group">
                  <textarea id="area1" rows="5"  class="form-control" placeholder="mô tả" name="motas"  required></textarea>
                  <div class="invalid-feedback">
              ...
              <input class="btn btn-primary d-block" type="submit" name="themmoi" value="thêm mới" onclick="nicEditors.findEditor('area1').saveContent();"/>
            </div>
            </div>
        </div>
      </div>
